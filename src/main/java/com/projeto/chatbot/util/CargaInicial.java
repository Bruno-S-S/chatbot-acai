...
public class CargaInicial implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) {
        ...
        if (mensagemService.findMensagens().isEmpty()) {
            ...
            mensagemService.newMensagem(new Mensagem(MensagensEnum.AJUDA.getFrase(), "Para realizar um pedido digite apenas o número da opção desejada. A qualquer momento digite \"ajuda\" para ver esta mensagem novamente", ""));
